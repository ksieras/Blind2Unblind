...
# Confocal_MICE_dir = os.path.join(opt.test_dirs, "Confocal_MICE")
# TwoPhoton_MICE_dir = os.path.join(opt.test_dirs, "TwoPhoton_MICE")
# valid_dict = {
